...
Instance: Ejemplo-RespuestaObsNecesidaddeRopa
InstanceOf: SDOHCCObservationScreeninigResponseCL
Usage: #example
Title: "Ejemplo Respuesta de observación SDOHCC PRAPARE - Necesidad de ropa"
Description: "Ejemplo de una respuesta de observación de detección que representa una pregunta y respuesta relacionada con las necesidades no satisfechas de ropa del cuestionario PRAPARE representadas en LOINC."
