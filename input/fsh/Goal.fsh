...
* description ^binding.description = "Códigos que proporcionan los detalles de un objetivo particular. En muchos sistemas, sólo se utilizará el elemento de texto."
