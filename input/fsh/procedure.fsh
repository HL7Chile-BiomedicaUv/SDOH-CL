...
* extension[pertainsToGoal] ^requirements = "Indica que el procedimiento está relacionado con la meta/objetivo de SDOHCC referenciada."
...
* extension[pertainsToGoal].value[x] ^requirements = "Indica que el procedimiento está relacionado con la meta/objetivo de SDOHCC referenciada."
* basedOn MS
...
* basedOn[SupportedBasedOn] ^short = "Una solicitud de servicio de SDOH para este procedimiento."
