...
* code ^binding.description = "Códigod que identifican nombres de observaciones simples."
* subject 1.. MS
...
* valueQuantity ^binding.description = "Este es el conjunto completo de códigos UCUM."  
...
* derivedFrom ^definition = "El recurso objetivo representa un QuestionnaireResponse u otra observación de la cual se inferió o calculó el valor de esta observación."
